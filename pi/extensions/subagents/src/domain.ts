...
export interface SpawnTask {
  ...
  /**
   * Tool allowlist for the child, from an agent role's frontmatter.
   * Honoured by the pi backend only; claude and codex own their own tool
   * policy, so they ignore it.
   */
