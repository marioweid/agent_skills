...
export default function modelInfo(pi: ExtensionAPI) {
  ...
  function refresh(ctx: ExtensionContext) {
    // This state only feeds the TUI footer. Headless children (subagents,
    // print mode) render nothing, and their ctx goes stale on session
    // teardown, so reading it there is both useless and an error.
