...
- Follow the user's global standards (AGENTS.md): fail fast with clear errors, never swallow exceptions, self-documenting code (no commented-out code), respect the hard limits (function length, params, line length, absolute imports).
